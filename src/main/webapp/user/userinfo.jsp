...
String basePath = "http://localhost:" + request.getServerPort() + "/" + path + "/";
%>
				...
				<form action="update" method="post">
					<ul class="list">
						<li><input id="J_euserName" class="long" readonly="readonly"
							name="username" value="${sessionScope.customer.username} "
							type="text" />
						...
						<li><input id="pwd" class="long" name="password"
							value="${sessionScope.customer.password}" type="text" />
						...
						<li><input id="J_euserName" class="long" name="zip"
							value="${sessionScope.customer.zip}" type="text" />
						...
						<li><input id="J_euserName" class="long" name="address"
							value="${sessionScope.customer.address}" type="text" />
						...
						<li><input id="J_euserName" class="long" name="phone"
							value="${sessionScope.customer.phone}" type="text" />
						...
						<li><input id="J_euserName" class="long" name="email"
							value="${sessionScope.customer.email}" type="text" />
